...
def data_preprocess():  # 返回：二维化的数据、Protein值、聚类标签
    ...
    # preprocessed_file_path = os.path.join(preprocessed_data_dir, filename)
    x_umap , Protein , cluster_ids_x = data_process.kmeans(original_file_path,preprocessed_data_dir)
